...
@Autonomous
public class stangaJos extends LinearOpMode {
    ...
    private void drive (double power, double leftInches, double rightInches) {
        ...
        if (opModeIsActive()) {
           ...
           // leftTarget = LeftDrive.getCurrentPosition() + (int)(leftInches * DRIVE_COUNTS_PER_IN);
            rightTarget = RightDrive.getTargetPosition() + (int)(rightInches * DRIVE_COUNTS_PER_CM);
            leftTarget = LeftDrive.getTargetPosition() + (int)(leftInches * DRIVE_COUNTS_PER_CM);
